                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach($brandIndex as $items)
                                        <tr>
                                            <th class="border-top-0">{{$loop->iteration}}</th>
                                            <th class="border-top-0">{{$items->title}}</th>
                                            <th class="border-top-0">{!! html_entity_decode($items->slug)!!}</th>
                                            ...
                                            <th>
                                                <a href="{{route('brand.edit',$items->id)}}" data-toggle="tooltip" class="btn btn-sm btn btn-outline-warning" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                                                <form action="{{route('brand.destroy',$items->id)}}" method ="POST">
                                                @csrf
                                                @method('DELETE')
