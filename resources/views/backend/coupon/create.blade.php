                    ...
                    <div class="container">                      
                        <div col-md-12 col-sm-12 >
                            <div class="form-group">
                                ...
                                <input name="code" class="form-control" placeholder="Coupon Code" value="{{old('code')}}" type="text">
                            </div>
                        </div>
                        ...
                        <div col-md-12 col-sm-12 >
                            <div class="form-group">
                                ...
                                <input name="value" class="form-control" placeholder="Coupon value" value="{{old('value')}}" type="text">
