                    ...
                    <div class="wrap-product-detail">
                        ...
                        <div class="detail-info">
                            ...
                            <div class="short-desc">
                                <ul>
                                    <p>{!! html_entity_decode($detail->summary) !!}</p>
                                </ul>
                            </div>
                            <div class="wrap-social">
                                <a class="link-socail" href="#"><img src="assets/images/social-list.png" alt=""></a>
                            </div>
                            <div class="wrap-price"><span class="product-price">Rs:{{ $detail->price }}</span></div>
                            <div class="stock-info in-stock">
                                <p class="availability">Availability: <b>{{ $detail->stock }}</b></p>
                            </div>
                            {{-- <div class="quantity">
                                <span>Quantity:</span>
                            ...
                            <div class="wrap-butons">
                                <a href="#" data-quntity="1" data-product-id="{{ $detail->id }}" class="btn add-to-cart add_to_cart" id="add_to_cart{{ $detail->id }}">Add to Cart</a>
                                <div class="wrap-btn">
                                    <a href="#" class="btn btn-compare">Add Compare</a>
                                    <a href="#" class="add-to-wishlistt btn btn-wishlist" id="add_to_wishlist{{$detail->id}}" data-quntity="1" data-product-id="{{$detail->id}}" href="javascript:void(0)">Add Wishlist</a>
                                    ...
                                    <div class="product product-style-2 equal-elem ">
                                        <div class="product-thumnail">
                                            <a href="{{ route('product-detail', $item->id) }}"
                                                ...
                                                @endphp
                                                <figure><img src="{{ $photos[0] }}" width="214" height="214"
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span
                                                    class="product-price">Rs.{{ $item->price }}</span></div>
                                        </div>
                                    </div>
                                @endforeach
...
{{-- add to wishlist --}}
<script>
    $(document).on('click', '.add-to-wishlistt', function(e) {
       e.preventDefault();
        var product_id = $(this).data('product-id');
        var product_quntity = $(this).data('quntity');
        // alert(product_quntity);
        ...
        $.ajax({
            ...
            beforeSend: function() {
                $('#add_to_wishlist'+product_id).html('<i class="fa fa-spinner fa-spin"></i> Loading...');
            },
            complete:function(){
               $('#add_to_wishlist'+product_id).html('Added To Wishlist');
